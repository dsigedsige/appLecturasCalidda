...
namespace DSIGE.Negocio
{
    public class NLectura
    {
        ...
        public DataTable NListaLecturaDetalladoEstado_new(int id_local, int id_servicio, string fechaini, string fechaFin, int idoperario, int categoriaLectura)
        {
            try
            {
                return new DLectura().DListaLecturaDetalladaEstado_New(id_local, id_servicio, fechaini, fechaFin, idoperario, categoriaLectura);
            }
            catch (Exception e)
            {
                throw e;
