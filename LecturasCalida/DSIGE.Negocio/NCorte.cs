...
namespace DSIGE.Negocio
{
    public class NCorte
    {
        ...
        public object Capa_Negocio_ListaExcel_enel(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            try
            {
                DCorte Objeto_Corte = new DCorte();
                return Objeto_Corte.Capa_Dato_ListaExcel_Enel(fileLocation, usuario, idlocal, idfechaAsignacion);
            }
            catch (Exception e)
            {
        ...
        public bool NCambioEstadoCorte_new(int id_tiposervicio, string fecha_asignacion, string suministro)
        {
            try
            {
                DCorte oCorte = new DCorte();
                return oCorte.Capa_Dato_Cambio_Estado_Corte_new(id_tiposervicio, fecha_asignacion, suministro); 
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Nreactivar_cortesReconexiones(int id_tiposervicio, string fecha_asignacion, string suministro, int id_usuario)
        {
            try
            {
                DCorte oCorte = new DCorte();
                return oCorte.Dreactivar_cortesReconexiones(id_tiposervicio, fecha_asignacion, suministro, id_usuario);
            }
            catch (Exception e)
            {
                throw e;
