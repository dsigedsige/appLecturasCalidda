...
namespace DSIGE.Web.Controllers
{
    public class OperarioController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Inserta(string __a, string __b, string __c, string __d, string __e,string __m, string __f, string __g, string __h, string __i, string __j, string __k, string __l, string __mail , string _v, string _lc, string _cv)
        {
            Int32 respuesta = new NOperario().NInserta(
                        new Request_CRUD_Operario()
                        {
                            ...
                            id_Vehiculo = _v,
                            licenciaConducir = _lc,
                            ConstanciaSCTRvigente = _cv
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Actualiza(string __a, string __b, string __c, string __d, string __e, string __f, string __g, string __h, string __i, string __j, string __k, string __l, string __m, string __mail, string _v, string _lc, string _cv)
        {
        ...
        public ActionResult enviarCorreoRecuparaContrasena(string __a, string __b, string __c)
            ...
            if (ModelState.IsValid)
            {
                var body = "<center><h1>Recuperación de Contraseña</h1></center> <p> Usuario : " + __a + ", su contraseña es : " + __c + 
                    "</p><p>Ingrese al sistema : <h1><a href='http://www.cobraperu.com/Lecturas'>Cobra Perú - Lecturas</a></h1></p><p></p><p></p><p>Atte.</p><p>Administrador Web</p><p>Lecturas COBRA Perú</p>";
