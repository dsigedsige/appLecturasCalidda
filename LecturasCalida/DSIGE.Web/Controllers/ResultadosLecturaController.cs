...
namespace DSIGE.Web.Controllers
{
    public class ResultadosLecturaController : Controller
    {
        ...
        public ActionResult res_reparto_index()
        {
            return View();
        }
        ...
        [HttpPost]
        public string ListandoSector()
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_ListandoSector();
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoResumenReparto(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_Get_ListaResumenReparto(FechaAsignacion, id_tiposervicio, id_sector);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoResumenReparto_Detallado(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_ListandoResumenReparto_Detallado(FechaAsignacion, id_tiposervicio, id_sector);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoResumenReparto_Detallado_New(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_ListandoResumenReparto_Detallado_New(FechaAsignacion, id_tiposervicio, id_sector);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoResumenReparto_Detallado_New2(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_ListandoResumenReparto_Detallado_New2(FechaAsignacion, id_tiposervicio, id_sector);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
