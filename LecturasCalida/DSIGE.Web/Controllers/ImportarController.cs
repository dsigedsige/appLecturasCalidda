    ...
    public class ImportarController : Controller
    {
        ...
        public string save_GrandesClientesfile(HttpPostedFileBase file, int Id_GrandeCliente, string CodigoEMR, int  id_marcaMedidor,  string fechaCarga)
        {
            ...
            try
            {
                ...
                //Cls_Negocio_Importacion_Lecturas objeto_negocio = new Cls_Negocio_Importacion_Lecturas();
                //resFile = objeto_negocio.Capa_Negocio_grabarGrandesClienteFile(Id_GrandeCliente, CodigoEMR, file.FileName, CodigoEMR + "-"+ correlativo + extension, id_marcaMedidor, fechaCarga, ((Sesion)Session["Session_Usuario_Acceso"]).usuario.usu_id);

                Cls_Negocio_Importacion_Lecturas objeto_negocio = new Cls_Negocio_Importacion_Lecturas();
                resFile = objeto_negocio.Capa_Negocio_grabarGrandesClienteFile(Id_GrandeCliente, CodigoEMR, file.FileName, "", id_marcaMedidor, fechaCarga, ((Sesion)Session["Session_Usuario_Acceso"]).usuario.usu_id);
