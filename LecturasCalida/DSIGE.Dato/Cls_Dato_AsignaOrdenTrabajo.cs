    ...
    public class Cls_Dato_AsignaOrdenTrabajo
    {
        ...
        public object Capa_Dato_download_grandesClientes(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int id_usuario)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LECTURA_GRANDES_CLIENTES_EXCEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string GenerarArchivoExcel_grandesClientes(DataTable dt_detalles, string nombreFile, string nombreExcel)
        {
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    ...
                    oWs.Cells[4, 1, 4, 15].Merge = true;  // combinar celdaS dt
                    ...
                    foreach (DataRow oBj in dt_detalles.Rows)
                    {
                        ...
                        oWs.Cells[_fila, 15].Value = oBj["tecnico"].ToString();
                    ...
                    using (SqlCommand cmd = new SqlCommand("NEW_DSIGE_S_LECTURA_ENVIAR_CLIENTE", cn))
                    {
                        ...
                        using (SqlDataReader Fila = cmd.ExecuteReader())
                        {
                            while (Fila.Read())
                            {
                                ...
                                if (id_tipo_servicio == 1 || id_tipo_servicio == 2 || id_tipo_servicio == 8)  // Lectura reclamos
                                {
                                    obj_entidad.checkeado = false;
                                ...
                                else if (id_tipo_servicio == 6 || id_tipo_servicio == 9 || id_tipo_servicio == 10)  // Repartos
                                {
                                    obj_entidad.checkeado = false;
                    ...
                    using (SqlCommand cmd = new SqlCommand("NEW_SP_S_LECTURA_ENVIAR_CLIENTE_DESCARGAR_PRE_ENVIO", cn))
                    {
                        ...
                        using (SqlDataReader Fila = cmd.ExecuteReader())
                        {
                            while (Fila.Read())
                            {
                                ...
                                if (id_tipo_servicio == 1 || id_tipo_servicio == 2 || id_tipo_servicio == 8)
                                {
                                    obj_entidad.nroInstalacion_lectura = Convert.ToString(Fila["nroInstalacion_lectura"]);
                                    ...
                                    obj_entidad.desplazamiento = Convert.ToString(Fila["desplazamiento"]);
                                    obj_entidad.ubicacion_Medidor = Convert.ToString(Fila["ubicacion_Medidor"]);
                                ...
                                else if (id_tipo_servicio == 3)
                                {
                                    ...
                                    obj_entidad.horaAviso = Convert.ToString(Fila["horaAviso"]);

                                    obj_entidad.horaInicio = Convert.ToString(Fila["horaInicio"]);
                                    obj_entidad.horaTermino = Convert.ToString(Fila["horaTermino"]);
                                ...
                                else if (id_tipo_servicio == 4)
                                {
                                    ...
                                    obj_entidad.primeraReconexion_corte = Convert.ToString(Fila["primeraReconexion_corte"]);
                                    obj_entidad.observacion = Convert.ToString(Fila["observacion"]);
                                    obj_entidad.ubicacion_Medidor = Convert.ToString(Fila["ubicacion_Medidor"]);
                                    obj_entidad.horaAviso = Convert.ToString(Fila["horaAviso"]);
        ...
        public string Capa_Dato_DescargaFoto(string List_codigos, int servicio, int flag_multiple, int id_usuario)
        {
            ...
            try
            {
                ...
                if (servicio == 1 || servicio == 2 || servicio == 8) /// lectura y Reclamos
                {
                    opcion = 1;
                }
                else if (servicio == 3 || servicio == 4)
                ...
                else if (servicio == 6 || servicio == 9 || servicio == 10)
                {
                    opcion = 3;
                }
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("NEW_SP_S_ENVIAR_TRABAJO_CLIENTE_FOTOS_MASIVO_SINOBSERVACION", cn))
                    {
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            if (dt_detalle.Rows.Count == 0)
                            {
                                return Res = "0|Lo sentimos, no hay fotos para descargar";                                 
                            }
        ...
        public string Capa_Dato_DescargaFoto_new_II(int local, int servicio, string fecha_asignacion, int id_usuario, int id_supervisor, int id_operario_supervisor, string tipoFoto)
        {
            string Res = "";
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("NEW_SP_S_ENVIAR_TRABAJO_CLIENTE_FOTOS_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.Add("@id_supervisor", SqlDbType.Int).Value = id_supervisor;
                        cmd.Parameters.Add("@id_operario_supervisor", SqlDbType.Int).Value = id_operario_supervisor;
                        cmd.Parameters.Add("@tipoFotoDescarga", SqlDbType.VarChar).Value = tipoFoto;
        ...
        public string Capa_Dato_DescargaFoto_new_sinObservacion_II(int local, int servicio, string fecha_asignacion, int id_usuario, int id_supervisor, int id_operario_supervisor, string tipoFoto)
        {
            string Res = "";
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("NEW_SP_S_ENVIAR_TRABAJO_CLIENTE_FOTOS_SIN_OBSERVACION_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_Dato_DescargarArchivoTexto_Naturgy(int id_tipo_servicio, string fechaAsignacion, int idUsuario)
        {
            string Resultado = "";
            try
            {
                cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                string _rutafile = "";
                string _nombreFile = "ArchivoNaturgy_" + idUsuario + ".txt";
                string _rutaServer = ConfigurationManager.AppSettings["servidor-archivos"];
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_NATURGY_ARCHIVO_TXT", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_servicio", SqlDbType.Int).Value = id_tipo_servicio;
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            foreach (DataRow Fila in dt_detalle.Rows)
                            {
                                linesArchivo[i] = Fila["naturgy_trabajos"].ToString();
                                i = i + 1;
                            }
                            ...
                            if (dt_detalle.Rows.Count <= 0)
                            {
                                ...
                                _rutafile = System.Web.Hosting.HostingEnvironment.MapPath("~/Upload/" + _nombreFile);

                                if (System.IO.File.Exists(_rutafile))
                                {
                                    System.IO.File.Delete(_rutafile);
                                }
        ...
        public string Capa_Dato_Set_procesarRecepcionLecturas(int servicio, string fechaAsigna, int idUsuario )
        {
            cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
            string Resultado = "";
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("DSIGE_LECTURA_ENVIAR_CLIENTE_Registrar_Lectura_New", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_Dato_Proceso_Actualizar_lecturas(int id_lectura, string valor_lectura, int id_usuario)
        {
            ...
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    //using (SqlCommand cmd = new SqlCommand("SP_U_ENVIAR_TRABAJO_CLIENTE_LECT_MANUAL", cn))
        ...
        public object Capa_Dato_get_vehiculos()
        {
            DataTable dt_detalle = new DataTable();
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_VEHICULOS", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        ...
        public List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio> Capa_Dato_set_generando_noCortar(int idLocal, int idServicio, int idEstado, string fechaAsigna, int idUsuario)
        {
            List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio> ListTecnico = new List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio>();
            var Resultado = "";
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_U_ENVIAR_TRABAJOS_NOCORTAR", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio> Capa_Dato_set_generando_noCortar_New(int idLocal, int idServicio, int idEstado, string fechaAsigna, int idUsuario)
        {
            List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio> ListTecnico = new List<Cls_Entidad_AsignaOrdenTrabajo.LecturaEnvio>();
            var Resultado = "";
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_U_ENVIAR_TRABAJOS_NOCORTAR_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
