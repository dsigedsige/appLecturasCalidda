...
namespace DSIGE.Dato
{
    public class DCorte
    {
        ...
        public bool Capa_Dato_ListaExcelcorte(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_CORTE_NEW", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Capa_Dato_Actualizar_Reparto(int id_operario, string unidad_lectura, int id_servicio, string fechaAsignatura, int id_operario_cambiar)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_UPDATE_OPERARIO_REPARTO_NEW_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Capa_Dato_Actualizar_Reparto_enel(int id_operario, string unidad_lectura, int id_servicio, string fechaAsignatura, int id_operario_cambiar)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_UPDATE_OPERARIO_REPARTO_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_dato_Generando_Compartir_lecturas(int id_servicio,string fecha, string cod_unidad, int id_operario)
        {
            ...
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("PROC_S_REPARTO_COMPARTIR_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_dato_Generando_Compartir_lecturas_enel(int id_servicio, string fecha, string cod_unidad, int id_operario)
        {
            cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
            string Resultado = "";
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_S_REPARTO_COMPARTIR_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_servicio", SqlDbType.Int).Value = id_servicio;
        ...
        public List<Reparto> Capa_Dato_Listar_Reparto(int servicio, string fechaAsignacion, int cod_usuario)
        {
            try
            {
                List<Reparto> oCortes = new List<Reparto>();
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_REPARTO_NEW_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_Listar_Reparto_Enel(int servicio, string fechaAsignacion, int cod_usuario)
        {
            DataTable dt_detalle = new DataTable();
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_REPARTO_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@SERVICIO", SqlDbType.Int).Value = servicio;
        ...
        public List<CorteTemporalCorte> Capa_Dato_Listar_Temporal_cortes_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_AGRUPADO_TEMPORAL_CORTE_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@USUARIO", SqlDbType.Int).Value = cod_usuario;
        ...
        public string Capa_Dato_Guardar_InformacionCorte(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            ...
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_IMPORTAR_EXCEL_GUARDAR_CORTES", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Capa_Dato_ListaExcelReparto(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_I_T_TEMPORAL_REPARTO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.ExecuteNonQuery();
                    ...
                    //eliminando registros del usuario
                    using (SqlCommand cmd = new SqlCommand("SP_E_TEMPORALREPARTO", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_usuario", SqlDbType.Int).Value = usuario;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        bulkCopy.BatchSize = 500;
                        bulkCopy.NotifyAfter = 1000;
                        bulkCopy.DestinationTableName = "TEMPORAL_REPARTO";
                        bulkCopy.WriteToServer(dt);

                        //Actualizando campos 

                        string Sql = "UPDATE TEMPORAL_REPARTO SET   loc_id ='" + idlocal + "' , idUsuarioExport='" + usuario + "', fechaAsignacion='" + idfechaAsignacion + "'  WHERE idUsuarioExport IS NULL   ";
        ...
        public object Capa_Dato_ListaExcelReparto_new(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            object resul = null;
            resul res = new resul();
            ...
            try
            {
                ...
                cn.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + fileLocation + ";Extended Properties='Excel 12.0;HDR=YES;IMEX=1';";
                cn.Open();
        ...
        public object  Capa_Dato_ListaExcel_Enel(string fileLocation, int usuario, int idlocal, string idfechaAsignacion)
        {
            object resul = null;
            resul res = new resul();
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(cadenaCnx))
                {
                    ...
                    //eliminando registros del usuario
                    using (SqlCommand cmd = new SqlCommand("SP_D_TEMPORAL_REPARTO_ENEL", con))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_usuario", SqlDbType.Int).Value = usuario;
                    ...
                    using (SqlBulkCopy bulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        bulkCopy.BatchSize = 500;
                        bulkCopy.NotifyAfter = 1000;
                        bulkCopy.DestinationTableName = "TEMPORAL_REPARTO_ENEL";
                        bulkCopy.WriteToServer(dt);

                        //Actualizando campos 

                        string Sql = "UPDATE TEMPORAL_REPARTO_ENEL SET   loc_id ='" + idlocal + "' , idUsuarioExport='" + usuario + "', fechaAsignacion='" + idfechaAsignacion + "'  WHERE idUsuarioExport IS NULL   ";
        ...
        public object Capa_Dato_Listar_Temporal_Enel_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            DataTable dt_detalle = new DataTable();
            resul res = new resul();
            object resul = null;
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_IMPORTAR_ARCHIVO_EXCEL_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@id_usuario", SqlDbType.Int).Value = cod_usuario;
        ...
        public object Capa_Dato_Guardar_Informacion_ExcelEnel(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            resul res = new resul();
            object resul = null;
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_I_IMPORTAR_ARCHIVO_EXCEL_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.Add("@id_TipoServicio", SqlDbType.Int).Value = id_servicio;
                        cmd.Parameters.Add("@archivoImportacion", SqlDbType.VarChar).Value = nombre_archivo;
                        cmd.Parameters.Add("@usuario", SqlDbType.Int).Value = usuario;
                        cmd.ExecuteNonQuery();
                        resul = "OK";
                    }
        ...
        public List<CorteTemporalCorte> Capa_Dato_Listar_Temporal_reconexiones_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_AGRUPADO_TEMPORAL_RECONEXIONES_NEW", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@USUARIO", SqlDbType.Int).Value = cod_usuario;
        ...
        public List<Reparto> Capa_Dato_Listar_Temporal_Reparto_Agrupado(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_LISTAR_REPARTO_TEMPORAL_AGRUPADO_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@USUARIO", SqlDbType.Int).Value = cod_usuario;
        ...
        public object Capa_Dato_Listar_Temporal_Reparto_Agrupado_new(string fechaAsignacion, int cod_usuario, int idServicio)
        {
            DataTable dt_detalle = new DataTable();
            resul res = new resul();
            object resul = null;
        ...
        public bool Capa_Dato_Guardar_InformacionReparto(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_I_TBL_RECONEXIONES_IMPORTAR_EXCELREPARTO", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_Dato_Guardar_InformacionReconexiones(string fechaAsignacion, int id_servicio, string nombre_archivo, int usuario)
        {
            ...
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_IMPORTAR_EXCEL_GUARDAR_RECONEXIONES", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Capa_Dato_Cambio_Estado_Corte_new(int id_tiposervicio, string fecha_asignacion, string suministro)
        {
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_U_CORTE_RECONEXION_VOLVER_EJECUTAR_OT", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fechaAsignacion_corte", SqlDbType.VarChar).Value = fecha_asignacion;
        ...
        public object Dreactivar_cortesReconexiones(int id_tiposervicio, string fecha_asignacion, string suministro, int id_usuario)
        {
            resul res = new resul();
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_U_CORTE_RECONEXION_REACTIVAR", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fechaAsignacion", SqlDbType.VarChar).Value = fecha_asignacion;
                        cmd.Parameters.Add("@idServicio", SqlDbType.Int).Value = id_tiposervicio;
                        cmd.Parameters.Add("@suministro", SqlDbType.VarChar).Value = suministro;
