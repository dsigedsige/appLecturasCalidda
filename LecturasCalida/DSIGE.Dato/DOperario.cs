...
namespace DSIGE.Dato
{
    public class DOperario
    {
        ...
        public int DInserta(Request_CRUD_Operario oRq)
        {
            try
            {
                return Convert.ToInt32(DatabaseFactory.CreateDatabase().ExecuteScalar("dsige_operario_new_II", 0, oRq.emp_id, oRq.loc_id, oRq.ope_documento, oRq.ope_documento_tipo, oRq.ope_apellido, oRq.ope_nombre, oRq.ope_foto, oRq.ope_celular, oRq.ope_usuario, oRq.ope_contrasenia, oRq.ope_online, oRq.ope_estado, oRq.ope_crea, 1, oRq.ope_tipo_usuario, oRq.ope_email, oRq.id_Vehiculo, oRq.licenciaConducir, oRq.ConstanciaSCTRvigente));
            }
            catch (Exception e)
            {
                throw e;
        ...
        public int DActualiza(Request_CRUD_Operario oRq)
        {
            try
            {
                return Convert.ToInt32(DatabaseFactory.CreateDatabase().ExecuteScalar("dsige_operario_new_II", oRq.ope_id, oRq.emp_id, oRq.loc_id, oRq.ope_documento, oRq.ope_documento_tipo, oRq.ope_apellido, oRq.ope_nombre, oRq.ope_foto, oRq.ope_celular, oRq.ope_usuario, oRq.ope_contrasenia, oRq.ope_online, oRq.ope_estado, oRq.ope_crea, 2, oRq.ope_tipo_usuario, oRq.ope_email,  oRq.id_Vehiculo, oRq.licenciaConducir, oRq.ConstanciaSCTRvigente));
            }
            catch (Exception e)
            {
                throw e;
                ...
                using (IDataReader oDr = DatabaseFactory.CreateDatabase().ExecuteReader("dsige_operario_new", oRq.ope_id, 0, 0, "", "", "", "", "", "", "", "", "", 0, 0, 5, "",""))
                {
                    if (oDr != null)
                    {
                        while (oDr.Read())
                        {
                            ...
                            oBj.id_Vehiculo = Convert.ToString(oDr["id_Vehiculo"]);
                            oBj.licenciaConducir = Convert.ToString(oDr["licenciaConducir"]);
                            oBj.ConstanciaSCTRvigente = Convert.ToString(oDr["ConstanciaSCTRvigente"]);
                        }
                    }
                }
