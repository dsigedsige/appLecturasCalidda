...
namespace DSIGE.Dato
{
    public class Cls_Dato_ResultadoLecturas
    {
       ...
       public List<ResultadoLecturas_E> Capa_Dato_Get_ListaServicio()
       {
        ...
        public object Capa_Dato_Get_ListaSectores()
        {
            DataTable dt_detalle = new DataTable();
            try
            {
               ...
               using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("SP_S_SECTOR", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
       ...
       public List<ResultadoLecturas_E> Capa_Dato_Get_ResumenLecturas(string FechaAsignacion, int id_tiposervicio, int id_supervisor, int id_operario_supervisor)
        ...
        public List<ResultadoLecturas_E> Capa_Dato_Get_ListaResumenReparto(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.Add("@FechaAsignacion", SqlDbType.VarChar).Value = FechaAsignacion;
                        cmd.Parameters.Add("@id_tiposervicio", SqlDbType.Int).Value = id_tiposervicio;
                        cmd.Parameters.Add("@id_sector", SqlDbType.Int).Value = id_sector;
       ...
       public List<ResultadoLecturas_E> Capa_Dato_Get_ResumenLecturas_Detallado(string FechaAsignacion, int id_tiposervicio, int id_supervisor, int id_operario_supervisor)
        ...
        public List<ResultadoLecturas_E> Capa_Dato_ListandoResumenReparto_Detallado(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            try
            {
                cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                {
                    cn.Open();
                     //using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL_DETALLE", cn))
                       using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL_DETALLE_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable  Capa_Dato_ListandoResumenReparto_Detallado_New(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            DataTable dt_detalle = new DataTable();
            try
            {
                ...
                {
                    cn.Open();
                    //using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL_DETALLE", cn))  u 
                    using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL_DETALLE_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable Capa_Dato_ListandoResumenReparto_Detallado_New2(string FechaAsignacion, int id_tiposervicio, int id_sector)
        {
            DataTable dt_detalle = new DataTable();
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("REPARTOS_ENEL_DETALLE_New", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
